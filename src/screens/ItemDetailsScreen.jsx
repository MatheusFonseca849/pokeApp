      ...
      >
        <Card style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <View style={styles.headerContainer}>
            ...
            <IconButton
              icon={
                favoriteItemIds.includes(itemInfo.id.toString())
                  ? "heart"
                  : "heart-outline"
              }
              ...
              onPress={() => {
                favoriteItemIds.includes(itemInfo.id.toString())
                  ? removeItemFromFavorites(itemInfo.id.toString())
                  : addItemToFavorites(itemInfo.id.toString());
              }}
            ></IconButton>
          </View>
          <View style={styles.imageContainer}>
            <Image
              source={{ uri: itemInfo.sprites.default }}
              style={styles.image}
            />
          </View>
          <View style={styles.infoContainer}>
            ...
            <Text style={{ color: theme.colors.onSurface }}>
              {itemInfo.flavor_text_entries[0].text}
            </Text>
          </View>
          <View style={styles.infoContainer}>
            <Text
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={{ color: theme.colors.onSurface }}>
              {itemInfo.effect_entries[0].effect.replace("\n", "")}
            </Text>
          </View>
        </Card>
      </GestureRecognizer>
